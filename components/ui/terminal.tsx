...
export function Terminal({
  ...
  return (
    <div
      ref={containerRef}
      className={cn(
        "mx-auto w-full max-w-xl px-0 font-terminal text-xs [font-variant-ligatures:none]",
        className
      )}
    >
      <div className="overflow-hidden rounded-lg border border-neutral-800 bg-neutral-900 shadow-2xl">
        ...
        <div
          ref={contentRef}
          className="h-64 overflow-y-auto p-4 font-terminal [font-variant-ligatures:none] [scrollbar-width:none] md:h-72 [&::-webkit-scrollbar]:hidden"
        >
          {lines.map((line, i) => (
